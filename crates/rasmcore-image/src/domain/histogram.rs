...
//! operations (equalize, normalize, auto-level, contrast stretch). All correction
//! operations compute a histogram, derive a [u8; 256] LUT, then apply it via the
//! shared `point_ops::apply_lut()` infrastructure — fusible with other point ops
//! in the pipeline.
