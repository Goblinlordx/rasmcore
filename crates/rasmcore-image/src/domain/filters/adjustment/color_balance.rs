...
impl crate::domain::filter_traits::GpuFilter for ColorBalanceParams {
    ...
    fn gpu_ops_with_format(
        ...
        static SHADER: LazyLock<String> = LazyLock::new(|| {
            include_str!("../../../shaders/color_balance_f32.wgsl").to_string()
        });
        let preserve = if self.preserve_luminosity { 1.0f32 } else { 0.0f32 };
        let mut params = Vec::with_capacity(64);
        params.extend_from_slice(&width.to_le_bytes());
        params.extend_from_slice(&height.to_le_bytes());
        params.extend_from_slice(&(self.shadow_cyan_red / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.shadow_magenta_green / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.shadow_yellow_blue / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.midtone_cyan_red / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.midtone_magenta_green / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.midtone_yellow_blue / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.highlight_cyan_red / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.highlight_magenta_green / 100.0).to_le_bytes());
        params.extend_from_slice(&(self.highlight_yellow_blue / 100.0).to_le_bytes());
        params.extend_from_slice(&preserve.to_le_bytes());
        params.extend_from_slice(&0u32.to_le_bytes()); // pad to 52 bytes
