...
pub fn otsu_threshold(input: &[f32], w: u32, h: u32) -> Vec<f32> {
    ...
    // Threshold sits between bin best_threshold and best_threshold+1.
    // Pixels with luminance in bins 0..=best_threshold → class 0 (black),
    // pixels in bins best_threshold+1..=255 → class 1 (white).
