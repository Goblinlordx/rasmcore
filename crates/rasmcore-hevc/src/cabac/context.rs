...
pub const SIG_COEFF_FLAG_INIT: [[u8; 42]; 3] = [
    ...
    [
        ...
        136, 153, 154, 166, 183, 140, 136, 153, 154, // Chroma (15 contexts)
    ...
    [
        ...
        179, 153, 125, 107, 125, 141, 179, 153, 125, 170, 153, 123, 123, 107, 121, 107, 121, 167,
...
pub const COEFF_ABS_LEVEL_GREATER2_FLAG_INIT: [[u8; 6]; 3] = [
    [107, 167, 91, 107, 167, 91], // I
    [107, 167, 91, 122, 152, 76], // P
    [107, 167, 91, 122, 152, 76], // B
];
