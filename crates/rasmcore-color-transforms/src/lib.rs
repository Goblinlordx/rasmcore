...
pub fn manifest() -> Vec<TransformEntry> {
    vec![
        ...
        TransformEntry {
            ...
            format: "clf", filename: "idt/srgb.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/rec709.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/rec2020.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/display-p3.clf",
        },
        ...
        TransformEntry {
            ...
            format: "clf", filename: "idt/arri-logc4.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/sony-slog3-sgamut3.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/sony-slog3-sgamut3cine.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/red-log3g10-rwg.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/canon-clog3.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/panasonic-vlog.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/blackmagic-gen5.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/blackmagic-dwg.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/apple-log.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "idt/dji-dlog.clf",
        },
        ...
        TransformEntry {
            ...
            format: "clf", filename: "utility/srgb-curve.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "utility/rec1886-curve.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "utility/st2084-pq-curve.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "utility/ap0-to-rec709.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "utility/ap0-to-p3.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "utility/ap0-to-rec2020.clf",
        },
        ...
        TransformEntry {
            ...
            format: "clf", filename: "ot/srgb-100nits.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/rec709-100nits.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/p3-48nits-dark.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/p3-100nits-dim.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/p3-1000nits-dim.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/rec2020-1000nits-dim.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/rec2020-2000nits-dim.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/rec2020-4000nits-dim.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "ot/rec2020-hlg-1000nits.clf",
        },
        ...
        TransformEntry {
            ...
            format: "clf", filename: "csc/acescg-to-cct.clf",
        },
        TransformEntry {
            ...
            format: "clf", filename: "csc/acescct-to-cg.clf",
        },
    ]
}
...
pub fn register_pack<E>(
    ...
    entries.iter().map(|(name, data)| {
        let format = manifest.iter()
            .find(|e| e.name == *name)
            .map(|e| e.format)
            .unwrap_or("clf");
...
pub fn filename_for(name: &str) -> Option<&'static str> {
    manifest().iter().find(|e| e.name == name).map(|e| e.filename)
}
...
mod tests {
    ...
    fn register_pack_calls_callback() {
        ...
        let results = register_pack(
            |_data, _fmt, _name| -> Result<u32, ()> { count += 1; Ok(count) },
            &[("idt-srgb", b"<ProcessList/>"), ("idt-rec709", b"<ProcessList/>")],
        );
