...
pub fn inverse_dct_16x16(input: &[i16; 256], output: &mut [i16; 256]) {
    ...
    for i in 0..16 {
        ...
        let add = 64;
        for j in 0..16 {
            tmp[s + j] = ((row[j] + add) >> 7).clamp(-32768, 32767);
        }
    }
...
fn fdct16_1d(x: &[i32]) -> [i32; 16] {
    ...
    result[1] = O16[0] * o[0]
        ...
        + O16[6] * o[6]
        + O16[7] * o[7];
    result[3] = O16[1] * o[0] - O16[4] * o[1] - O16[7] * o[2] - O16[5] * o[3] - O16[2] * o[4]
        + O16[0] * o[5]
        + O16[3] * o[6]
        + O16[6] * o[7];
    ...
    result[7] = O16[3] * o[0] - O16[5] * o[1] + O16[6] * o[2] + O16[0] * o[3]
        ...
        + O16[4] * o[6]
        + O16[2] * o[7];
    result[9] = O16[4] * o[0] - O16[2] * o[1] + O16[0] * o[2] - O16[7] * o[3] - O16[3] * o[4]
        + O16[6] * o[5]
        + O16[5] * o[6]
        - O16[1] * o[7];
    ...
    result[13] = O16[6] * o[0] - O16[3] * o[1] + O16[1] * o[2] - O16[4] * o[3]
        ...
        - O16[0] * o[6]
        + O16[2] * o[7];
    result[15] = O16[7] * o[0] - O16[6] * o[1] + O16[5] * o[2] - O16[4] * o[3] + O16[3] * o[4]
        - O16[2] * o[5]
        + O16[1] * o[6]
        - O16[0] * o[7];
